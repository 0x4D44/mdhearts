...
fn hard_prefers_dumping_qs_over_small_heart_to_leader() {
    ...
    assert!(
        qs_total >= h_total,
        "QS total {} should be >= heart total {} when feeding leader",
        qs_total,
        h_total
    );
