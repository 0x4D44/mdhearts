...
fn exact_flip_seed_2031_east() {
    ...
    assert_eq!(n_top, Card::new(Rank::Nine, Suit::Spades), "Normal top changed for 2031/East");
    assert_eq!(h_top, Card::new(Rank::Ace, Suit::Diamonds), "Hard top changed for 2031/East");
